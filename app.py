...
def api_upload_print():
    """Endpoint usado pelo robô de coleta automática:
    - No PC (coletor_baus.py): envia o arquivo como multipart, campo 'print_baus'.
    - No celular (Automate): o app não suporta multipart, então envia um JSON
      com o print convertido em Base64, no campo 'image_base64'.
